...
export function CollectionCard({ c }: { c: CollectionSummary }) {
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-xl border border-white/10 bg-white/[0.03] transition hover:border-white/25 hover:bg-white/[0.06]"
    >
      ...
      <div className="flex flex-col gap-1 p-3">
        <div className="flex items-center gap-1">
          ...
          {c.verified && <span className="text-sky-400" title="Verified creator">✔</span>}
        </div>
